...
export default function Hero() {
    ...
    return (
        <div id="hero" ref={containerRef} className="relative h-screen w-full overflow-hidden bg-zinc-900 font-kanit [clip-path:inset(0_0_0_0)]">
            ...
            {/* Main Content */}
            <div className="relative z-10 container mx-auto h-full flex flex-col justify-end pb-10 px-6 lg:pl-10">
                <div className="max-w-2xl">
                    <h1 className="text-4xl sm:text-6xl lg:text-8xl text-stroke-red-50 text-white/80 leading-[1.1] tracking-wide drop-shadow-lg">
                        ตัวแทนจำหน่าย <br />
